...
const About = ()=>{
    return(
       <section className={Styles.about} id="about">
         ...
         <Card title="free shiping" text="variations of passages of Lorem Ipsum available" image={{src:free,alt:"free shiping"}}/>
         <Card title="best quality" text="variations of passages of Lorem Ipsum available" image={{src:quality,alt:"best quality"}}/>
